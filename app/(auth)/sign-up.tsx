            ...
            <View className="flex-1 bg-white">
                <View className="relative w-full h-[250px]">
                    <Image 
                        ...
                        resizeMode="contain"
                    />
                    <Text className="text-2xl text-blavk font-JakarataSemiBold bottom-10 left-5">
                        Create Your Account
                    </Text>
                </View>
                <View className="p-5">
                ...
                <ReactNativeModal isVisible={showSuccessModal} >
                    <View className="bg-white px-7 py-9 rounded-2xl min-h-[300px]">
                        ...
                        <CustomButton title="Browse Home" onPress={() => {setShowSuccessModal(false); router.push('/(root)/(tabs)/home')}} className="mt-5" />
                    </View>
                </ReactNativeModal>
